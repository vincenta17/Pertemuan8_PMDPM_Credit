...
st.set_page_config(
    page_title="11699 - Unsupervised Learning",
    page_icon="🧊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - 11699</h1>", unsafe_allow_html=True) 
    st.dataframe(input_data)

model_directory = r'D:\Semester 5\Pembelajaran Mesin Dan Mendalam\module 4\Tugas4_B_11699'
model_path = {
